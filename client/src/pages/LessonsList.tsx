    ...
    <div className="min-h-screen bg-muted/20">
      ...
      <main className="container py-10 lg:py-14">
        ...
        {lessonsQuery.isLoading ? (
          <div className="rounded-3xl border border-border/70 bg-card py-20 text-center"><div className="mx-auto h-10 w-10 animate-spin rounded-full border-2 border-primary/20 border-t-primary" /><p className="mt-4 text-muted-foreground">جاري تحميل الأرشيف...</p></div>
